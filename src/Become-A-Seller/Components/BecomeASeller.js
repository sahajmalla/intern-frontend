...
const BecomeASeller = () => {
    ...
    const isLoading = useSelector(state => state.BecomeASellerReducers.loading)
    const hasError = useSelector(state => state.BecomeASellerReducers.error)
                        ...
                        <main className="mt-10 mx-auto px-4 sm:mt-12 sm:px-6 md:mt-6 lg:mt-6 lg:px-8 xl:mt-8 h-full">
                            ...
                            <div className="space-y-8 lg:flex lg:space-x-10">
                                ...
                                <div>
                                    ...
                                    {isSuccess && (
                                        <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800 mb-5">

                                            <div className="px-4 py-2 -mx-3">
                                                <div className="mx-3">
                                                    <span className="font-semibold text-green-500 dark:text-green-400">Success</span>
                                                    <p className="text-sm text-gray-600 dark:text-gray-200">Your details has been forwared to the admin, please wait unit we verify you. You will soon be getting an email to verify our app in your instagram.</p>
                                                </div>
                                            </div>
                                    ...
                                    {hasError && (
                                        <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800 mb-5">
                                            ...
                                            <div className="px-4 py-2 -mx-3">
                                                <div className="mx-3">
                                                    <span className="font-semibold text-red-500 dark:text-red-400">Error could not register. Please try again later</span>
                                                    {/* <p className="text-sm text-gray-600 dark:text-gray-200">Your details has been forwared to the admin, please wait unit we verify you. You will soon be getting an email to verify our app in your instagram.</p> */}
                                                </div>
                                            </div>
                                        ...
                                        <form onSubmit={handleSubmit(onSubmit)}>
                                            ...
                                            <div className="flex justify-end mt-6">
                                                ...
                                                {isLoading ?
                                                    <button
                                                        disabled={true}
                                                        className=" flex px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-indigo-300 rounded-md  focus:outline-none focus:bg-indigo-600 rounded-lg">

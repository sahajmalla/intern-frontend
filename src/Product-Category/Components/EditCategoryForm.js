...
import { hideEditForm, tryEditCategory } from '../redux/action/EditCategoryFormActions'
...
const EditCategoryForm = () => {
    ...
    const onSubmit = data => {
        ...
        if (data.category_image.length !== 0) {
            ...
            { toEditCategoryID && dispatch(tryEditCategory(formData, toEditCategoryID)) };

        } else {
            console.log(`im without file`);
            let finalData = {
                category_name: data.category_name,
                category_description: data.category_description
            }
            { toEditCategoryID && dispatch(tryEditCategory(finalData, toEditCategoryID)) };
        }
                ...
                <div className="relative w-screen my-6 mx-auto max-w-6xl ">
                    ...
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className="flex justify-between items-center pt-4 px-2">
                            ...
                            <button onClick={() => dispatch(hideEditForm())} className="modal-close cursor-pointer z-50">
